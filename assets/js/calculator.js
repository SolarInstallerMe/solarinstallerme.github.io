...
var interface =
  '<style type="text/css">#calcTable {width:auto;border:none;background:white;font-family:\'Verdana\';font-size:12px;font-weight:bold;empty-cells:show;border-collapse:collapse;}#calcTable .inputTop {height:5px;overflow:hidden;padding:0;margin:0;border:none;border-bottom:1px solid #aaa;}#calcTable .inputBottom {height:10px;overflow:hidden;padding:0;margin:0;border:1px solid #aaa;border-top:none;}#calcTable .inputButton {border:none;text-align:right;padding-top:5px;}#calcTable .inputButton input {font-weight:bold;color:#fff;background:#000;padding:3px 5px 3px 5px;border:3px solid #000;}#calcTable .inputButton input:hover {border:3px outset #0e0;}#calcTable .inputButton input:active {border:3px inset #0e0;}#calcTable .title {background-color:#63bcd8;font-size:16px;padding:8px;color:#020202;border:none;}#calcTable .typeCell, #calcTable .billCell {border-left:1px solid #aaa;text-align:center;}#calcTable td {padding:20px 2px 5px 2px;border-right:1px solid #aaa;}#calcTable th {padding:20px 2px 5px 2px;border-left:1px solid #aaa;text-align:right;}#calcTable tr.out th, #calcTable tr.out td  {text-align:left;border:none;border-top:1px solid #272727;padding:8px;}#calcTable tr.out td {text-align:right;}#calcTable tr.out td.col {text-align:center;}#calcTable tr.hd th, #calcTable tr.hd td {border:none;font-size:14px;padding-top:15px;}#calcTable tr.hd th {color:#141413;}#calcTable tr.res th, #calcTable tr.res td {font-size:16px;border:none;background:#9cf;}#calcTable tr.out td.outSpacer {padding:0;margin:0;height:10px;overflow:hidden;}#calcTable .outputButton {border:none;text-align:right;padding-top:5px;}#calcTable .outputButton input {font-weight:bold;color:#000;background:#fff;padding:3px 5px 3px 5px;border:3px solid #ddd;}#calcTable .outputButton input:hover {border:3px outset #ccc;}#calcTable .outputButton input:active {border:3px inset #ccc;}#calcTable .out {display:none;}</style><table id=calcTable cellspacing=0 cellpadding=0><tr class=in><td colspan=3 class=inputTop></td></tr><tr class=in><th>State:</th><td colspan=2 width=><select name=state id=state></select></td></tr><tr class="in ut"><th>Utility:</th><td colspan=2><select name=utility id=utility></select></td></tr><tr class=in><td colspan=3 class=typeCell><input type=radio name=type id=typeR value="r" /> <label for=typeR>Residential</label> &nbsp; &nbsp; <input type=radio name=type id=typeC value="c" /> <label for=typeC>Commercial</label></td></tr><tr class=in><td colspan=3 class=billCell>Monthly Bill: <input type=text name=monthly id=monthly size=10 /></td></tr><tr class=in><td colspan=3 class=inputBottom></td></tr><tr class=in><td colspan=3 class=inputButton><input type=button id=submitBtn value="Submit" /></td></tr><tr class="out hd"><th colspan=3>What it costs</th></tr><tr class=out><th colspan=2>Retail Price</th><td id=outPrice></td></tr><tr class="out rebate"><th colspan=2 id=outRebateTitle>State Rebates</th><td id=outRebate></td></tr><tr class=out><th colspan=2>Federal Tax Credits</th><td>30%</td></tr><tr class="out credit"><th colspan=2>State Tax Credits</th><td id=outCredit></td></tr><tr class=out><td colspan=3 class=outSpacer></td></tr><tr class="out res"><th colspan=2>Cost</th><td id=outFinalCost></td></tr><tr class="out hd"><th>Savings</th><td class=col>Monthly</td><td class=col>Annually</td></tr><tr class=out><th>Estimated Savings</th><td class=col id=outSaving1></td><td class=col id=outSaving2></td><tr class=out><td colspan=3 class=outputButton><input type=button id=backBtn value="&lt;&lt; Back" /></td></tr></table>';
document.write(interface);
jQuery(function ($) {
  var stateSelect = $("#calcTable #state");
  var utilSelect = $("#calcTable #utility");
  var utilRow = $("#calcTable tr.ut").hide();
  stateSelect.append($("<option />").html(" - Select  - ").attr("value", -1));
  ...
  function updateUtils() {
    ...
    if (newState == -1 || states[newState]["utilities"] == undefined) {
      ...
      utilSelect.empty();
      utilSelect.append(
        $("<option />").html(" - Select  - ").attr("value", -1)
      );
